...
class SignUpVM : ViewModel() {
    ...
    var passwordReenter: MutableState<String> = mutableStateOf("")
    var passwordEnterError: MutableState<Boolean> = mutableStateOf(false)
    var passwordReEnterError: MutableState<Boolean> = mutableStateOf(false)
    var passwordReEnterLabel: MutableState<String> = mutableStateOf("")
    ...
    var signUpState: MutableState<Int> = mutableIntStateOf(1)
    ...
    @Composable
    fun HandleBack() {
        BackHandler(signUpState.value != 1) {
            signUpState.value--
        }
    }
